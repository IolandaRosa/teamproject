...
import steps.US15WithNoOptionFeatureSteps;

@RunWith(Parameterized.class)
public class US15WithNoOptionFeatureTest extends GreenCoffeeTest {
    @Rule
    ...
    public static Collection<ScenarioConfig> data() throws IOException {
        return new GreenCoffeeConfig().withFeatureFromAssets("assets/features/featureUS15WithNoOption.feature").scenarios();
    }

    @Test
    public void test() {
        start(new US15WithNoOptionFeatureSteps());
    }
