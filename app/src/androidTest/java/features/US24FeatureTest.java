...
import steps.US24FeatureSteps;

@RunWith(Parameterized.class)
public class US24FeatureTest extends GreenCoffeeTest {
    @Rule
    ...
    public US24FeatureTest(ScenarioConfig scenario) {
        super(scenario);
    }

    @Parameterized.Parameters(name = "{0}")
    public static Collection<ScenarioConfig> data() throws IOException {
        return new GreenCoffeeConfig().withFeatureFromAssets("assets/features/featureUS24.feature").scenarios();
    }

    @Test
    public void test() {
        start(new US24FeatureSteps());
    }
