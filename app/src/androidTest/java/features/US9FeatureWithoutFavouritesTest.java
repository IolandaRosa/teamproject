...
public class US9FeatureWithoutFavouritesTest extends GreenCoffeeTest {
    ...
    public static Collection<ScenarioConfig> data() throws IOException {
        return new GreenCoffeeConfig().withFeatureFromAssets("assets/features/featureUS9WithoutFavourites.feature").scenarios();
    }

    @Test
    public void test() {
        start(new US9FeatureWithoutFavouritesSteps());
    }
