...
import steps.US19FavouriteListFeatureSteps;
import steps.US19FeatureSteps;

@RunWith(Parameterized.class)
public class US19FavouriteListFeatureTest extends GreenCoffeeTest {
    @Rule
    ...
    public US19FavouriteListFeatureTest(ScenarioConfig scenario) {
        super(scenario);
    }

    @Test
    public void test() {
        start(new US19FavouriteListFeatureSteps());
    }

    @Parameterized.Parameters (name = "{0}")
    public static Collection<ScenarioConfig> data() throws IOException {
        return new GreenCoffeeConfig().withFeatureFromAssets("assets/features/featureUS19FavouriteList.feature").scenarios();
    }
