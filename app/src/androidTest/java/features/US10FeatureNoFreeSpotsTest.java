...
public class US10FeatureNoFreeSpotsTest extends GreenCoffeeTest {
    ...
    public US10FeatureNoFreeSpotsTest(ScenarioConfig scenario) {
        super(scenario);
    }

    @Parameterized.Parameters (name = "{0}")
    public static Collection<ScenarioConfig> data() throws IOException {
        return new GreenCoffeeConfig().withFeatureFromAssets("assets/features/featureUS10NoFreeSpots.feature").scenarios();
    }

    @Test
    public void test() {
        start(new US10FeatureNoFreeSpotsSteps());
    }
